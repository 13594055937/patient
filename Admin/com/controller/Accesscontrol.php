...
function exportExcel($title=array(), $data=array(), $fileName='', $savePath='./', $isDown=false){
	// include dirname(__FILE__).'/../../../../tp5/vendor/PHPExcel/PHPExcel.php';
	// include 'C:\PHP\php11\WWW\order\order-v1.0\order/HPExcel/HPExcel.php';
	...
	$_savePath = $savePath.$_fileName.'.xlsx';
	 ...
	 // return '成功导出到'.$savePath.$fileName.'.xlsx'.'中。';
}
