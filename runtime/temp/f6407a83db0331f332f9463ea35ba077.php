<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:63:"C:\PHP\php11\WWW\Patient/Admin/patient\view\patient\upload.html";i:1523517895;}*/ ?>
<html>
<head>
	<meta charset="UTF-8">
...
$("#file-1").fileinput({
        ...
        uploadExtraData:{pash:file_pash},
        ...
        layer.msg(index.response.message,{icon:1,time:1500});
        console.log(index);
        if(index.response.status==1){
