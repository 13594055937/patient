<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:61:"C:\PHP\php11\WWW\Patient/Admin/patient\view\patient\file.html";i:1523515391;s:75:"C:\PHP\php11\WWW\Patient/Admin/patient\view\..\..\com\view\public\meta.html";i:1521619099;s:77:"C:\PHP\php11\WWW\Patient/Admin/patient\view\..\..\com\view\public\footer.html";i:1523166087;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
			...
			<div class="mt-20">
				<table class="table table-border table-bordered table-hover table-bg table-sort" id="">
					...
					<?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
						<tr class="text-c">
							<td><a href="<?php echo url('fileinfo',['id'=>$vo['file_id']]); ?>"><?php echo $vo['customer_name']; ?> 相关文件</a></td>
