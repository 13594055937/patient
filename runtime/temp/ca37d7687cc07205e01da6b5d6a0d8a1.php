<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:58:"C:\PHP\php11\WWW\Patient/Admin/login\view\login\index.html";i:1523583342;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
		...
		<form class="form form-horizontal">
			...
			<div class="row cl">
				<div class="formControls col-xs-5 col-xs-offset-3">
					<input onclick="submit_form()" type="button" class="btn btn-block btn-success ml-50 radius size-L" value="&nbsp;登&nbsp;&nbsp;&nbsp;&nbsp;录&nbsp;">
				</div>
			</div>
		</form>
	</div>
